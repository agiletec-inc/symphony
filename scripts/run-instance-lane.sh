...
manifest=$1; lane=$2; checkout=$3; binary=$4; config_root=$5; log_root=$6
...
exec "$binary" "$workflow" --logs-root "$log_root" --i-understand-that-this-will-be-running-without-the-usual-guardrails
